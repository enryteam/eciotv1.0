...
class Hessian2Writer
{
    ...
    function writeArray($array)
    {
        ...
        /*
         * ::= x57 value* 'Z' # variable-length untyped list ::= x58 int value* # fixed-length untyped list ::= [x78-7f] value* # fixed-length untyped list
         */
    ...
    function writeMap($map, $type = '')
    {
        if (empty($map))
            ...
            /*
         * ::= 'M' type (value value)* 'Z' # key, value map pairs ::= 'H' (value value)* 'Z' # untyped key, value
         */
