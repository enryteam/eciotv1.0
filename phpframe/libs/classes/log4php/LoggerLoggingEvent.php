...
class LoggerLoggingEvent
{
     ...
     * <p>It only recognize informations generated by {@link Logger} and its
     * subclasses.</p>
     *
    ...
    public function getLocationInformation()
    {
        if ($this->locationInfo === null) {
            ...
            while ($hop !== null) {
                if (isset($hop['class'])) {
                    // we are sometimes in functions = no class available: avoid
                    // php warning here
     ...
     * thread or even on a different machine. The {@link LoggerNDC::get()}
     * method
