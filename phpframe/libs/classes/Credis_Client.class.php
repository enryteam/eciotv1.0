...
class Credis_Client
{
     ...
     * @var array
     */
    protected $aliasedMethods = array(
        'delete' => 'del',
        'getkeys' => 'keys',
        'sremove' => 'srem'
    );
     ...
     */
    public function __construct($host = 'localhost', $port = 6379, $timeout = null, $persistent = '')
    {
     ...
     * If falsey, a timeout will not be set. Negative values not supported.
     *
     * @param
     *            $timeout
     * @throws CredisException
            ...
            try {
                ...
                if ($name == 'pipeline' || $name == 'multi') {
                    ...
                    if ($name == 'exec' || $name == 'discard') {
                        ...
                        // cho "> $name : ".substr(print_r($response, TRUE),0,100)."\n";
                        return $response;
                    }
