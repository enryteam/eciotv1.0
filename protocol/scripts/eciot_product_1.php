...
// //默认参数$conn,$gateway,$terminal,$arr
 ...
 function eciot_product_1($conn,$gateway,$terminal,$arr){
...
//  $sql = "INSERT INTO `eciot_product_1`(`terminal_id`, `sn`, `pm1`, `pm2`, `ctime`) VALUES ('".$terminal['id']."','".$terminal['sn']."','".$arr['params']['pm25']."','".$arr['params']['pm100']."','".$arr['timestamp']."')";
