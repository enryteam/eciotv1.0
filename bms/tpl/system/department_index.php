    ...
    <div class="layui-card">
      <div class="layui-card-body">
        <div style="padding-bottom: 10px;">
          <button class="layui-btn layuiadmin-btn-role" data-type="add" onclick="window.location.href='./index.php?c=system&a=department_edit'">机构添加</button>
        </div>
                          ...
                          <tbody id="check_box">
                              ...
                              <tr data-index="0" class="">
                                  ...
                                  <td data-field="limits" data-key="4-0-3" class="">
                                      <div class="layui-table-cell laytable-cell-4-0-3"><?php echo $vo['fid_name']?></div>
                                  </td>
                                  <td data-field="limits" data-key="4-0-3" class="">
                                      <div class="layui-table-cell laytable-cell-4-0-3"><?php echo $vo['title']?></div>
                                  </td>
                                  ...
                                  <td data-field="5" data-key="4-0-4" align="" data-off="true" class="layui-table-col-special">
                                      <div class="layui-table-cell laytable-cell-4-0-4">
                                          <a class="layui-btn layui-btn-normal layui-btn-xs" lay-event="edit" href="./index.php?c=system&a=department_edit&id=<?php echo $vo['id']?>">
                                              编辑
                                          </a> 
                                          <a class="layui-btn layui-btn-danger layui-btn-xs" lay-event="del"  href="javascript: if(window.confirm('该管理员组确定要你删除吗?')) location.href='./index.php?c=system&a=department_remove&id=<?php echo $vo['id']?>'">
                                             删除
                                          </a> 
                                      </div>
                                  </td>
