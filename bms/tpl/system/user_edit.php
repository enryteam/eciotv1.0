...
<html>
  ...
  <body>
    ...
    <div class="layui-fluid">
      <div class="layui-card">
        <div class="layui-card-header">成员添加/编辑</div>
          ...
          <form class="layui-form"  lay-filter="component-form-group">
            ...
            <div class="layui-form-item">
              ...
              <div class="layui-input-inline">
                <select name="department_id" lay-filter="fid" >
            ...
            <div class="layui-form-item">
              ...
              <div class="layui-input-inline">
                <input type="text" name="phone" value="<?php echo $detail['phone'] ?>" lay-verify="phone" autocomplete="off" placeholder="请输入" class="layui-input">
              </div>
            </div>
            <div class="layui-form-item">
              <label class="layui-form-label">成员地址</label>
              <div class="layui-input-inline">
                <input type="text" name="addr" value="<?php echo $detail['addr'] ?>" lay-verify="addr" autocomplete="off" placeholder="请输入" class="layui-input">
              </div>
            </div>
            <div class="layui-form-item">
  ...
  //            console.log(data.field.title);
          $.post('index.php', {c: 'system', a: 'user_edit', id: data.field.id, department_id: data.field.department_id,user_name: data.field.user_name,phone:data.field.phone,addr:data.field.addr}, function (response) {
            var responseObj = $.parseJSON(response);
            if (responseObj.errorCode == 200) {
              window.location.href = './index.php?c=system&a=user_index';
            } else {
