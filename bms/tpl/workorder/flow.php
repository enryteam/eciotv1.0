    ...
    <div class="layui-fluid">   
      <div class="layui-card">
        ...
        <div class="layui-card-body">
          ...
          <a class="layui-btn layuiadmin-btn-role" data-type="add" onclick="window.location.href='./index.php?c=workorder&a=flow_edit'">添加配置</a>
          </div>
                  ...
                  <tbody id="check_box">
                    <?php foreach ($lists as $ke => $vo) { ?>
                      <tr data-index="0" class="">
                        ...
                        <td data-field="rolename" data-key="4-0-2" class="">
                          <div class="layui-table-cell"><?php echo $vo['remark'] ?></div>
                        </td>
                        <td data-field="rolename" data-key="4-0-2" class="">
                       ...
                       <td data-field="5" data-key="4-0-7" align="" data-off="true" class="layui-table-col-special">
                          <div class="layui-table-cell ">
                            <a class="layui-btn layui-btn-normal layui-btn-xs" href="<?php echo pfUrl(" ","workorder","flow_edit",array("id"=>$vo['id']))?>">
                              <i class="layui-icon ">编辑</i>
                            </a> 
                            <a class="layui-btn layui-btn-normal layui-btn-xs" href="<?php echo pfUrl(" ","workorder","flow_remove",array("id"=>$vo['id']))?>">
