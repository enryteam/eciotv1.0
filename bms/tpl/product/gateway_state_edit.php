      ...
      <div class="layui-card">
        ...
        <form action="###" method="post" class="layui-form">
          ...
          <div class="layui-form-item">
            ...
            <div class="layui-input-inline">
              <input type="text" name="keys" value="<?php echo $details["keys"] ?>" lay-verify="keys" autocomplete="off" placeholder="请输入" class="layui-input">
            </div>
          </div>
          <div class="layui-form-item">
            <label class="layui-form-label">字段值：</label>
            <div class="layui-input-inline">
              <input type="text" name="value" value="<?php echo $details["value"] ?>" lay-verify="keys" autocomplete="off" placeholder="请输入" class="layui-input">
            </div>
          </div>
    ...
    <script>
                ...
                layui.config({
                  ...
                  form.on('submit(component-form-element)',function (data){
                        console.log(data);
                        $.post('index.php', {c: 'product', a: 'gateway_state_edit', id:data.field.id,product_id:data.field.product_id,name:data.field.name,keys:data.field.keys,value:data.field.value}, function (response) {
