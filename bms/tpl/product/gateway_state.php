            ...
            <form name="searchform" action="index.php?c=star&amp;a=index" method="POST">
                    ...
                    <div class="layui-form layui-card-header layuiadmin-card-header-auto">
                      <div class="layui-form-item">
                        <a class="layui-btn layuiadmin-btn-role" data-type="add" onclick="window.location.href = '<?php echo pfUrl(" ", "product", "gateway_state_edit",array('product_id'=>$r['id'])) ?>'">添加产品事件</a>
                       
                         <a class="layui-btn layuiadmin-btn-role" style="background-color:#1E9FFF;" data-type="add" onclick="window.location.href = '<?php echo pfUrl(" ", "product", "index") ?>'">返回产品</a>
                      </div>
                    </div>
            ...
            <div class="layui-table-box">
              <div class="layui-table-body" style="overflow:auto; ">
                <table cellspacing="0" cellpadding="0" border="0" class="layui-table" style="width:100%">
                    <caption style="height:40px;border-bottom: 1px #808080 solid ;"><?php echo $r['name'].'的事件'?></caption>
                  <thead>
                    <tr>
                    ...
                    <?php foreach ($lists as $ke => $vo) { ?>
                      <tr data-index="0" class="">
                        <td data-field="id" data-key="4-0-2" class="">
                          <div class="layui-table-cell laytable-cell-4-0-2"><?php echo $vo['id'] ?></div>
                        </td>
                        ...
                        <td data-field="rolename" data-key="4-0-2" class="">
                          <div class="layui-table-cell laytable-cell-4-0-2"><?php echo $vo['content'] ?></div>
                        </td>
                     
                        <td data-field="5" data-key="4-0-7" align="" data-off="true" class="layui-table-col-special">
                          <div class="layui-table-cell ">
                            <a class="layui-btn layui-btn-normal layui-btn-xs" href="<?php echo pfUrl(" ","product","gateway_state_edit",array("id"=>$vo['id'],'product_id'=>$vo['product_id']))?>">
                              <i class="layui-icon ">编辑</i>
                            </a>
                              <a class="layui-btn layui-btn-danger layui-btn-xs" href="<?php echo pfUrl(" ","product","gateway_state_remove",array("id"=>$vo['id'],'product_id'=>$vo['product_id']))?>">
...
<?php echo $pages; ?>
    ...
    <script>
                ...
                function debug(id,product_id,name){
                    //'../protocol/index.php?c=协议脚本文件名不带.php&a=msg_encode',
                    $.ajax({
                    type: 'POST',
                    url: '../protocol/index.php?c=协议脚本文件名不带.php&a=msg_encode',
                    dataType: 'json',
